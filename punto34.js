...
let limit = parseInt(prompt("cuantas personas quieres ingresar"))
for (i = 0; i < limit; i++) {
...
function ubicar(list) {
    ...
    if (nombreE == true) {
        console.log("el estudiante " + listEstudiantes[ubicacion] + " en la ubicacion " + ubicacion + 1 + " del listado")
